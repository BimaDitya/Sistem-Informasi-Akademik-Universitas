<nav class="navbar navbar-expand navbar-dark shadow-sm" style="background-color: #82C5C5">
    <div class="container">
            ...
            <ul class="navbar-nav me-auto mx-1 mb-lg-0">
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light {{ ($Title === 'Mahasiswa') ? 'active' : '' }}"
                        href="/Admin">Mahasiswa</a>
                </li>
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light {{ ($Title === 'Perkuliahan') ? 'active' : '' }}" 
                    href="/Admin/Perkuliahan">Perkuliahan</a>
                </li>
                <li class="nav-item mx-1">
                ...
                <li class="nav-item mx-1">
                    <a class="btn btn-outline-light {{ ($Title === 'KRS') ? 'active' : '' }}" href="#">KRS</a>
                </li>
                <li class="nav-item mx-1">
