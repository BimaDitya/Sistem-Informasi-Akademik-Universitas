...
<body>
    ...
    <main>
        ...
        <div id="Biodata" class="container border rounded-3">
            ...
            <form action="/DataMahasiswa" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-5 row">
                    <label for="JalurPenerimaan" class="col-sm-2 col-form-label">Jalur Penerimaan</label>
                        <div class="col-sm-10">
                            <select id="jalur" name="JalurPenerimaan" class="form-control" required>
                                <option disabled selected>Pilih Jalur Penerimaan</option>
        ...
        <div id="Alamat" class="container border rounded-3 mt-5">
            ...
            <!--Alamat Sekolah-->
            <div class="sekolah-asal">
                <h2 class="mb-3 mt-5">Alamat Rumah</h2>
                <div class="d-flex flex-row bd-highlight mb-3">
                    <div class="col-md-3 mb-3  row">
                        <label for="inputnama" class="col-sm-2 col-form-label">Desa</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="inputnama" placeholder="Desa">
                        </div></div>
                    <div class="col-md-3 mb-3 row ms-3">
                        <label for="inputnama" class="col-sm-2 col-form-label ">Dusun</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="inputnama" placeholder="Dusun">
                        </div></div>
                    <div class="col-md-3 mb-3 row ms-3">
                        <label for="inputnama" class="col-sm-2 col-form-label">RT</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="inputnama" placeholder="RT">
                        </div></div>
                    <div class="col-md-3 mb-3 row ms-3">
                        <label for="inputnama" class="col-sm-2 col-form-label">RW</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="inputnama" placeholder="RW">
                        </div></div>
                </div>
                ...
                <div class="d-flex flex-row bd-highlight mb-3">
                    <div class="col-md-6 mb-3  row">
                        <label for="inputnama" class="col-sm-1 col-form-label">Jalan</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="inputnama" placeholder="Jalan">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3 ms-4 row">
                        <label for="inputnama" class="col-sm-1 col-form-label">KodePos</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="inputnama" placeholder="KodePos">
                        </div>
                    </div>
                </div>
            </div>
